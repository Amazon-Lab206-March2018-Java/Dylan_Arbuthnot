			...
			<div class="col-4 white">
				<table>
					...
					<tbody>
						...
						<tr>
							<td><a href="/languages/<c:out value="${lang.getId()}"/>"><c:out value="${lang.getName()}"/></a></td>
							<td><c:out value="${lang.getCreator()}"/></td>
							<td><c:out value="${lang.getCurrentVersion()}"/></td>
							<td><a href="/languages/delete/<c:out value="${lang.getId()}"/>">Delete</a>&nbsp;|&nbsp;<a href="/languages/edit/<c:out value="${lang.getId()}"/>">Edit</a></td>
						</tr>
						</c:forEach>
					</tbody>
				</table>
